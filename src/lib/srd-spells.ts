/**
 * SRD 5.1 spell list (CC-BY-4.0, Wizards of the Coast) bundled for the
 * one-click spell compendium. Generated from the open 5e-bits/5e-database
 * dataset — edit the source data, not this file.
 */
...
export const SRD_SPELLS: SeedSpell[] = [
  {
    "name": "Acid Splash",
    "level": 0,
    "school": "Conjuration",
